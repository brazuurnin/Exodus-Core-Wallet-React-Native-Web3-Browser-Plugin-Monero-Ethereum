...
var ecdsaSig = require('Exoduscore/signature');
...
var buf_to_sign = require("Exoduscore/secrethelper").sha256hash(new Buffer(JSON.stringify(message1)));
//获取签名的私钥
...
const webhelper = require('Exoduscore/webhelper')
